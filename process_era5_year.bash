...
compute_q2_ERA5 ./original/ERA5_2m_dewpoint_temperature_${year}.nc ERA5_surface_pressure_${year}.nc d2m sp ./processed/ERA5_2m_specific_humidity_${year}.nc
...
# combine precips
merge_precips_ERA5 ./original/ERA5_convective_rain_rate_${year}.nc ERA5_large_scale_rain_rate_${year}.nc crr lsrr ./processed/ERA5_total_rainfall_rate_${year}.nc rain

merge_precips_ERA5 ./original/ERA5_convective_snowfall_rate_water_equivalent_${year}.nc ERA5_large_scale_snowfall_rate_water_equivalentrunoff_${year}.nc csfr lssfr ./processed/ERA5_total_snowfall_rate_${year}.nc snow
